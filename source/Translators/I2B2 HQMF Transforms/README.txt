...
HQMFtoIntermediate.xsl - Converts an HQMF XML to the intermediate "ihqmf" representation.
IntermediateToI2B2.xsl - Converts an ihqmf XML back to an i2b2 message. Requires a live i2b2 ONT cell which will accept the security 
   parameters suggested in the xsl params to look up key names from basecodes.
